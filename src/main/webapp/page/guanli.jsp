...
<TABLE class=house-list>
  ...
  <c:forEach items="${pageInfo.list}" var="h">
    <TR>
      ...
      <TD class=house-price><LABEL class=ui-green><INPUT onclick="location.href='delHouse?id=${h.id}';" value="删除" type=button name=search></LABEL></TD></TR>
  </c:forEach>
